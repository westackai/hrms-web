      ...
      <Card className="shadow-md border border-gray-200 rounded-xl">
        ...
        <CardContent className="pt-3">
              ...
              {titles.map((t, idx) => (
                <TabsTrigger
                  ...
                  className={`relative flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 ${
                    idx === activeIndex ? "bg-white shadow-md ring-2 ring-blue-500" : "bg-transparent hover:bg-white/50"
                  } ${idx > activeIndex ? "opacity-40 cursor-not-allowed" : "cursor-pointer"}`}
                >
                  <div className="flex items-center gap-3 w-full">
                    ...
                    <div className="flex flex-col text-left flex-1">
                      <span className={`text-sm font-medium ${idx === activeIndex ? "text-blue-600" : "text-gray-800"}`}>
                        {t}
                      </span>
          ...
          <div className="flex items-center justify-between mt-6">
            ...
            {activeIndex === 0 && (
              <Button onClick={handleBack} className="h-10 bg-red-500 hover:bg-red-600 text-white">
                Cancel
              </Button>
            )}
